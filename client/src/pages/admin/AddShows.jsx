...
const AddShows = () => {
  ...
  const fetchNowPlayingMovies = async () => {
    try {
      ...
      // TMDB now-playing list from dummy data
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(data.message || "Could not add show");
    } catch {
      toast.success("Show saved in demo mode. Connect MongoDB and TMDB to persist it.");
      setSelectedMovie(null);
      setDateTimeSelection({});
      setShowPrice("");
    } finally {
