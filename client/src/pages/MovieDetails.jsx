...
const MovieDetails = () => {
  ...
  const { shows, favoriteMovies, toggleFavorite, dummyDateTimeData, image_base_url } = useAppContext();
  ...
  return (
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <button
              type="button"
              onClick={() => (user ? toggleFavorite(show.movie._id) : openSignIn())}
      ...
      {trailerOpen && (
        <TrailerModal videoUrl={show.movie.trailerUrl || dummyTrailers[0].videoUrl} onClose={() => setTrailerOpen(false)} />
      )}
    </div>
  );
};
